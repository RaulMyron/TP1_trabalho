    ...
    */
    ...
    public class GerenciarCandidaturas extends javax.swing.JFrame {
        ...
        private void atualizarStatusCandidatura() {
            ...
            String cpfCandidato = jTable2.getValueAt(row, 1).toString();
            String statusAtual = jTable2.getValueAt(row, 3).toString();
            ...
            if (novoStatus != null && !novoStatus.equals(statusAtual)) {
                try {
                    ...
                    telas.candidatura.Model.Candidatura candidaturaParaAtualizar = null;
                    
                    for (telas.candidatura.Model.Candidatura cand : candidaturas) {
                        if (cand.getCandidato() != null && 
                            cand.getCandidato().getCpf().equals(cpfCandidato) &&
                            cand.getVaga() != null &&
                            cand.getVaga().getCargo().equals(vagaSelecionada)) {
                            
                            candidaturaParaAtualizar = cand;
                            break;
                        }
                    }
                    
                    if (candidaturaParaAtualizar != null) {
                        candidatoController.alterarStatusCandidatura(candidaturaParaAtualizar, novoStatus);
